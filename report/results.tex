...
In general we noted comparable, and in some cases slightly lower, performances than the same networks trained on the original dataset. A few examples can be seen in \tab{tab:ae_comp}.
